...
public class CoinomeDraft extends Draft {
   ...
   * @since 1.3.5
   */
  public CoinomeDraft(IExtension inputExtension) {
   ...
   * @since 1.3.5
   */
  public CoinomeDraft(List<IExtension> inputExtensions) {
   ...
   * @since 1.3.7
   */
  public CoinomeDraft(List<IExtension> inputExtensions, List<IProtocol> inputProtocols) {
  ...
  public Draft copyInstance() {
    ...
    return new CoinomeDraft(newExtensions, newProtocols);
  }
  ...
  public boolean equals(Object o) {
    ...
    CoinomeDraft that = (CoinomeDraft) o;
