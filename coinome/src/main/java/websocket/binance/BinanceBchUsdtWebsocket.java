...
public class BinanceBchUsdtWebsocket {
  WebSocketClient mWs = null;
  HashMap<String, String> headers = new HashMap<String, String>();
  private Gson gson = new GsonBuilder().setPrettyPrinting().create();

  public BinanceBchUsdtWebsocket() {
  ...
  private WebSocketClient createWebSocket() throws URISyntaxException {
    return new WebSocketClient(new URI("wss://stream2.binance.com:9443/ws/bccusdt@kline_1w.b10"),
        new BinanceDraft(),
        headers,
        2000) {
      @Override
      public void onMessage(String message) {
        ...
        Double BCH_USDT = new Double((String) ((Map) mapMessage.get("k")).get("c"));

        Common.binanceMap.put("BCH_USDT", BCH_USDT);
      }
