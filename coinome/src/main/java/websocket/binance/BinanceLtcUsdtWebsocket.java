...
public class BinanceLtcUsdtWebsocket {
  WebSocketClient mWs = null;
  HashMap<String, String> headers = new HashMap<String, String>();
  private Gson gson = new GsonBuilder().setPrettyPrinting().create();

  public BinanceLtcUsdtWebsocket() {
  ...
  private WebSocketClient createWebSocket() throws URISyntaxException {
    return new WebSocketClient(new URI("wss://stream2.binance.com:9443/ws/ltcusdt@kline_1w.b10"),
        new BinanceDraft(),
        headers,
        2000) {
      @Override
      public void onMessage(String message) {
        ...
        Double LTC_USDT = new Double((String) ((Map) mapMessage.get("k")).get("c"));

        Common.binanceMap.put("LTC_USDT", LTC_USDT);
      }
