...
public class BinanceDraft extends Draft {
   ...
   * @since 1.3.5
   */
  public BinanceDraft(IExtension inputExtension) {
   ...
   * @since 1.3.5
   */
  public BinanceDraft(List<IExtension> inputExtensions) {
   ...
   * @since 1.3.7
   */
  public BinanceDraft(List<IExtension> inputExtensions, List<IProtocol> inputProtocols) {
  ...
  public Draft copyInstance() {
    ...
    return new BinanceDraft(newExtensions, newProtocols);
  }
  ...
  public boolean equals(Object o) {
    ...
    BinanceDraft that = (BinanceDraft) o;
